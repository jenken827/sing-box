...
type ServiceStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        ServiceStatus_Type     `protobuf:"varint,1,opt,name=status,proto3,enum=sbox.daemon.ServiceStatus_Type" json:"status,omitempty"`
...
type DefaultLogLevel struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Level         LogLevel               `protobuf:"varint,1,opt,name=level,proto3,enum=sbox.daemon.LogLevel" json:"level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ConnectionEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          ConnectionEventType    `protobuf:"varint,1,opt,name=type,proto3,enum=sbox.daemon.ConnectionEventType" json:"type,omitempty"`
...
type USBSharedDevice struct {
	...
	Backend       USBBackend             `protobuf:"varint,4,opt,name=backend,proto3,enum=sbox.daemon.USBBackend" json:"backend,omitempty"`
	State         USBDeviceState         `protobuf:"varint,5,opt,name=state,proto3,enum=sbox.daemon.USBDeviceState" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_started_service_proto_rawDesc = "" +
	"\n" +
	"\x15started_service.proto\x12\vsbox.daemon\x1a\x1bgoogle/protobuf/empty.proto\"C\n" +
	"\aVersion\x12\x18\n" +
	...
	"apiVersion\"\xb2\x01\n" +
	"\rServiceStatus\x127\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1f.sbox.daemon.ServiceStatus.TypeR\x06status\x12\"\n" +
	...
	"\x03Log\x124\n" +
	"\bmessages\x18\x01 \x03(\v2\x18.sbox.daemon.Log.MessageR\bmessages\x12\x14\n" +
	"\x05reset\x18\x02 \x01(\bR\x05reset\x1aP\n" +
	"\aMessage\x12+\n" +
	"\x05level\x18\x01 \x01(\x0e2\x15.sbox.daemon.LogLevelR\x05level\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\">\n" +
	"\x0fDefaultLogLevel\x12+\n" +
	"\x05level\x18\x01 \x01(\x0e2\x15.sbox.daemon.LogLevelR\x05level\"\xb6\x02\n" +
	"\x06Status\x12\x16\n" +
	...
	"\rdownlinkTotal\x18\t \x01(\x03R\rdownlinkTotal\"2\n" +
	"\x06Groups\x12(\n" +
	"\x05group\x18\x01 \x03(\v2\x12.sbox.daemon.GroupR\x05group\"\xb3\x01\n" +
	"\x05Group\x12\x10\n" +
	...
	"\x05items\x18\x06 \x03(\v2\x16.sbox.daemon.GroupItemR\x05items\"w\n" +
	"\tGroupItem\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12\x12\n" +
	...
	"\binterval\x18\x01 \x01(\x03R\binterval\"\xf4\x01\n" +
	"\x0fConnectionEvent\x124\n" +
	"\x04type\x18\x01 \x01(\x0e2 .sbox.daemon.ConnectionEventTypeR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x127\n" +
	"\n" +
	"connection\x18\x03 \x01(\v2\x17.sbox.daemon.ConnectionR\n" +
	"connection\x12 \n" +
	"\vuplinkDelta\x18\x04 \x01(\x03R\vuplinkDelta\x12$\n" +
	"\rdownlinkDelta\x18\x05 \x01(\x03R\rdownlinkDelta\x12\x1a\n" +
	"\bclosedAt\x18\x06 \x01(\x03R\bclosedAt\"^\n" +
	"\x10ConnectionEvents\x124\n" +
	"\x06events\x18\x01 \x03(\v2\x1c.sbox.daemon.ConnectionEventR\x06events\x12\x14\n" +
	"\x05reset\x18\x02 \x01(\bR\x05reset\"\x9a\x05\n" +
	"\n" +
	"Connection\x12\x0e\n" +
	...
	"\tchainList\x18\x15 \x03(\tR\tchainList\x12:\n" +
	"\vprocessInfo\x18\x16 \x01(\v2\x18.sbox.daemon.ProcessInfoR\vprocessInfo\"\xa5\x01\n" +
	...
	"\x12DeprecatedWarnings\x12:\n" +
	"\bwarnings\x18\x01 \x03(\v2\x1e.sbox.daemon.DeprecatedWarningR\bwarnings\"\xed\x01\n" +
	...
	"\tStartedAt\x12\x1c\n" +
	"\tstartedAt\x18\x01 \x01(\x03R\tstartedAt\"D\n" +
	"\fOutboundList\x124\n" +
	"\toutbounds\x18\x01 \x03(\v2\x16.sbox.daemon.GroupItemR\toutbounds\"\xb7\x01\n" +
	...
	"\x10natTypeSupported\x18\b \x01(\bR\x10natTypeSupported\"[\n" +
	"\x15TailscaleStatusUpdate\x12B\n" +
	"\tendpoints\x18\x01 \x03(\v2$.sbox.daemon.TailscaleEndpointStatusR\tendpoints\"\xa4\x03\n" +
	...
	"\x04self\x18\a \x01(\v2\x1a.sbox.daemon.TailscalePeerR\x04self\x12?\n" +
	"\n" +
	"userGroups\x18\b \x03(\v2\x1f.sbox.daemon.TailscaleUserGroupR\n" +
	"userGroups\x126\n" +
	"\bexitNode\x18\t \x01(\v2\x1a.sbox.daemon.TailscalePeerR\bexitNode\x12\x18\n" +
	"\akeyAuth\x18\n" +
	" \x01(\bR\akeyAuth\"\xc4\x01\n" +
	...
	"\rprofilePicURL\x18\x04 \x01(\tR\rprofilePicURL\x120\n" +
	"\x05peers\x18\x05 \x03(\v2\x1a.sbox.daemon.TailscalePeerR\x05peers\"\xd3\x03\n" +
	...
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\"\xd1\x01\n" +
	"\x19TailscaleSSHClientMessage\x126\n" +
	"\x05start\x18\x01 \x01(\v2\x1e.sbox.daemon.TailscaleSSHStartH\x00R\x05start\x126\n" +
	"\x05input\x18\x02 \x01(\v2\x1e.sbox.daemon.TailscaleSSHInputH\x00R\x05input\x129\n" +
	"\x06resize\x18\x03 \x01(\v2\x1f.sbox.daemon.TailscaleSSHResizeH\x00R\x06resizeB\t\n" +
	"\amessage\"\xcc\x02\n" +
	...
	"\fheightPixels\x18\x04 \x01(\x05R\fheightPixels\"\xcd\x02\n" +
	"\x19TailscaleSSHServerMessage\x12E\n" +
	"\n" +
	"authBanner\x18\x01 \x01(\v2#.sbox.daemon.TailscaleSSHAuthBannerH\x00R\n" +
	"authBanner\x126\n" +
	"\x05ready\x18\x02 \x01(\v2\x1e.sbox.daemon.TailscaleSSHReadyH\x00R\x05ready\x129\n" +
	"\x06output\x18\x03 \x01(\v2\x1f.sbox.daemon.TailscaleSSHOutputH\x00R\x06output\x123\n" +
	"\x04exit\x18\x04 \x01(\v2\x1d.sbox.daemon.TailscaleSSHExitH\x00R\x04exit\x126\n" +
	"\x05error\x18\x05 \x01(\v2\x1e.sbox.daemon.TailscaleSSHErrorH\x00R\x05errorB\t\n" +
	"\amessage\"2\n" +
	...
	"\x12USBProviderMessage\x126\n" +
	"\x06attach\x18\x01 \x01(\v2\x1c.sbox.daemon.USBDeviceAttachH\x00R\x06attach\x126\n" +
	"\x06detach\x18\x02 \x01(\v2\x1c.sbox.daemon.USBDeviceDetachH\x00R\x06detach\x12?\n" +
	"\vurbResponse\x18\x03 \x01(\v2\x1b.sbox.daemon.USBURBResponseH\x00R\vurbResponseB\t\n" +
	"\amessage\"\xf6\x01\n" +
	"\x10USBServerMessage\x123\n" +
	"\x05ready\x18\x01 \x01(\v2\x1b.sbox.daemon.USBDeviceReadyH\x00R\x05ready\x12<\n" +
	"\n" +
	"urbRequest\x18\x02 \x01(\v2\x1a.sbox.daemon.USBURBRequestH\x00R\n" +
	"urbRequest\x125\n" +
	"\x05abort\x18\x03 \x01(\v2\x1d.sbox.daemon.USBEndpointAbortH\x00R\x05abort\x12-\n" +
	"\x05error\x18\x04 \x01(\v2\x15.sbox.daemon.USBErrorH\x00R\x05errorB\t\n" +
	"\amessage\"\x8c\x04\n" +
	...
	"\x11numConfigurations\x18\f \x01(\rR\x11numConfigurations\x129\n" +
	"\n" +
	"interfaces\x18\r \x03(\v2\x19.sbox.daemon.USBInterfaceR\n" +
	"interfaces\x12\x16\n" +
	"\x06serial\x18\x0e \x01(\tR\x06serial\x12\x18\n" +
	"\aproduct\x18\x0f \x01(\tR\aproduct\"q\n" +
	"\x0fUSBDeviceAttach\x12\x1c\n" +
	"\tserverTag\x18\x01 \x01(\tR\tserverTag\x12@\n" +
	"\n" +
	"descriptor\x18\x02 \x01(\v2 .sbox.daemon.USBDeviceDescriptorR\n" +
	"descriptor\"\x92\x01\n" +
	"\fUSBInterface\x12&\n" +
	...
	"\x05busId\x18\x02 \x01(\tR\x05busId\"\xa6\x03\n" +
	...
	" \x01(\x05R\n" +
	"startFrame\x12\x1a\n" +
	"\binterval\x18\v \x01(\x05R\binterval\x129\n" +
	"\n" +
	"isoPackets\x18\f \x03(\v2\x19.sbox.daemon.USBIsoPacketR\n" +
	"isoPackets\"\xcd\x01\n" +
	...
	"\x06inData\x18\x05 \x01(\fR\x06inData\x129\n" +
	"\n" +
	"isoPackets\x18\x06 \x03(\v2\x19.sbox.daemon.USBIsoPacketR\n" +
	"isoPackets\"z\n" +
	...
	"\x17USBIPServerStatusUpdate\x128\n" +
	"\aservers\x18\x01 \x03(\v2\x1e.sbox.daemon.USBIPServerStatusR\aservers\"i\n" +
	"\x11USBIPServerStatus\x12\x1c\n" +
	"\tserverTag\x18\x01 \x01(\tR\tserverTag\x126\n" +
	"\adevices\x18\x02 \x03(\v2\x1c.sbox.daemon.USBSharedDeviceR\adevices\"\xeb\x01\n" +
	"\x0fUSBSharedDevice\x12@\n" +
	"\n" +
	"descriptor\x18\x01 \x01(\v2 .sbox.daemon.USBDeviceDescriptorR\n" +
	"descriptor\x12\x14\n" +
	"\x05busId\x18\x02 \x01(\tR\x05busId\x12\x1a\n" +
	"\bstableId\x18\x03 \x01(\tR\bstableId\x121\n" +
	"\abackend\x18\x04 \x01(\x0e2\x17.sbox.daemon.USBBackendR\abackend\x121\n" +
	"\x05state\x18\x05 \x01(\x0e2\x1b.sbox.daemon.USBDeviceStateR\x05state\"_\n" +
	"\x17OpenConnectStatusUpdate\x12D\n" +
	"\tendpoints\x18\x01 \x03(\v2&.sbox.daemon.OpenConnectEndpointStatusR\tendpoints\"\x98\x02\n" +
	"\x19OpenConnectEndpointStatus\x12 \n" +
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12\x1c\n" +
	"\tstateText\x18\x03 \x01(\tR\tstateText\x12K\n" +
	"\rauthChallenge\x18\x04 \x01(\v2%.sbox.daemon.OpenConnectAuthChallengeR\rauthChallenge\x12\x14\n" +
	"\x05error\x18\x05 \x01(\tR\x05error\x12B\n" +
	"\n" +
	"tunnelInfo\x18\x06 \x01(\v2\".sbox.daemon.OpenConnectTunnelInfoR\n" +
	"tunnelInfo\"\xd9\x01\n" +
	...
	"\x0econnectedSince\x18\b \x01(\x03R\x0econnectedSince\"\xfb\x01\n" +
	...
	"\x04form\x18\x05 \x01(\v2 .sbox.daemon.OpenConnectAuthFormH\x00R\x04form\x12B\n" +
	"\abrowser\x18\x06 \x01(\v2&.sbox.daemon.OpenConnectBrowserRequestH\x00R\abrowserB\v\n" +
	"\tchallenge\"T\n" +
	"\x13OpenConnectAuthForm\x12=\n" +
	"\x06fields\x18\x01 \x03(\v2%.sbox.daemon.OpenConnectAuthFormFieldR\x06fields\"\xd6\x01\n" +
	...
	"\aoptions\x18\x06 \x03(\v2&.sbox.daemon.OpenConnectAuthFormChoiceR\aoptions\"G\n" +
	...
	"\x06values\x18\x02 \x03(\tR\x06values\"\xa6\x01\n" +
	"\x1bOpenConnectAuthFormResponse\x12L\n" +
	"\x06values\x18\x01 \x03(\v24.sbox.daemon.OpenConnectAuthFormResponse.ValuesEntryR\x06values\x1a9\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb8\x01\n" +
	"\x18OpenConnectBrowserResult\x12\x1a\n" +
	"\bfinalURL\x18\x01 \x01(\tR\bfinalURL\x12?\n" +
	"\acookies\x18\x02 \x03(\v2%.sbox.daemon.OpenConnectBrowserCookieR\acookies\x12?\n" +
	"\aheaders\x18\x03 \x03(\v2%.sbox.daemon.OpenConnectBrowserHeaderR\aheaders\"\xf6\x01\n" +
	"!OpenConnectAuthResponseSubmission\x12 \n" +
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\x12 \n" +
	"\vchallengeID\x18\x02 \x01(\tR\vchallengeID\x12>\n" +
	"\x04form\x18\x03 \x01(\v2(.sbox.daemon.OpenConnectAuthFormResponseH\x00R\x04form\x12A\n" +
	"\abrowser\x18\x04 \x01(\v2%.sbox.daemon.OpenConnectBrowserResultH\x00R\abrowserB\n" +
	"\n" +
	"\bresponse\"d\n" +
	"\x1eOpenConnectAuthChallengeCancel\x12 \n" +
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\x12 \n" +
	"\vchallengeID\x18\x02 \x01(\tR\vchallengeID\"W\n" +
	"\x13OpenVPNStatusUpdate\x12@\n" +
	"\tendpoints\x18\x01 \x03(\v2\".sbox.daemon.OpenVPNEndpointStatusR\tendpoints\"\x80\x02\n" +
	"\x15OpenVPNEndpointStatus\x12 \n" +
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12\x1c\n" +
	"\tstateText\x18\x03 \x01(\tR\tstateText\x12;\n" +
	"\tchallenge\x18\x04 \x01(\v2\x1d.sbox.daemon.OpenVPNChallengeR\tchallenge\x12\x14\n" +
	"\x05error\x18\x05 \x01(\tR\x05error\x12>\n" +
	"\n" +
	"tunnelInfo\x18\x06 \x01(\v2\x1e.sbox.daemon.OpenVPNTunnelInfoR\n" +
	"tunnelInfo\"\xd7\x01\n" +
	...
	"\x1bUSB_BACKEND_WINDOWS_VBOXUSB\x10\x042\xc3\x16\n" +
	"\x0eStartedService\x12<\n" +
	"\n" +
	"GetVersion\x12\x16.google.protobuf.Empty\x1a\x14.sbox.daemon.Version\"\x00\x12P\n" +
	"\x16SubscribeServiceStatus\x12\x16.google.protobuf.Empty\x1a\x1a.sbox.daemon.ServiceStatus\"\x000\x01\x12<\n" +
	"\fSubscribeLog\x12\x16.google.protobuf.Empty\x1a\x10.sbox.daemon.Log\"\x000\x01\x12L\n" +
	"\x12GetDefaultLogLevel\x12\x16.google.protobuf.Empty\x1a\x1c.sbox.daemon.DefaultLogLevel\"\x00\x12=\n" +
	"\tClearLogs\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x12O\n" +
	"\x0fSubscribeStatus\x12#.sbox.daemon.SubscribeStatusRequest\x1a\x13.sbox.daemon.Status\"\x000\x01\x12B\n" +
	"\x0fSubscribeGroups\x12\x16.google.protobuf.Empty\x1a\x13.sbox.daemon.Groups\"\x000\x01\x12L\n" +
	"\x12GetClashModeStatus\x12\x16.google.protobuf.Empty\x1a\x1c.sbox.daemon.ClashModeStatus\"\x00\x12H\n" +
	"\x12SubscribeClashMode\x12\x16.google.protobuf.Empty\x1a\x16.sbox.daemon.ClashMode\"\x000\x01\x12@\n" +
	"\fSetClashMode\x12\x16.sbox.daemon.ClashMode\x1a\x16.google.protobuf.Empty\"\x00\x12@\n" +
	"\aURLTest\x12\x1b.sbox.daemon.URLTestRequest\x1a\x16.google.protobuf.Empty\"\x00\x12N\n" +
	"\x0eSelectOutbound\x12\".sbox.daemon.SelectOutboundRequest\x1a\x16.google.protobuf.Empty\"\x00\x12N\n" +
	"\x0eSetGroupExpand\x12\".sbox.daemon.SetGroupExpandRequest\x1a\x16.google.protobuf.Empty\"\x00\x12c\n" +
	"\x14SubscribeConnections\x12(.sbox.daemon.SubscribeConnectionsRequest\x1a\x1d.sbox.daemon.ConnectionEvents\"\x000\x01\x12P\n" +
	"\x0fCloseConnection\x12#.sbox.daemon.CloseConnectionRequest\x1a\x16.google.protobuf.Empty\"\x00\x12G\n" +
	"\x13CloseAllConnections\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x12R\n" +
	"\x15GetDeprecatedWarnings\x12\x16.google.protobuf.Empty\x1a\x1f.sbox.daemon.DeprecatedWarnings\"\x00\x12@\n" +
	"\fGetStartedAt\x12\x16.google.protobuf.Empty\x1a\x16.sbox.daemon.StartedAt\"\x00\x12K\n" +
	"\x12SubscribeOutbounds\x12\x16.google.protobuf.Empty\x1a\x19.sbox.daemon.OutboundList\"\x000\x01\x12n\n" +
	"\x17StartNetworkQualityTest\x12&.sbox.daemon.NetworkQualityTestRequest\x1a'.sbox.daemon.NetworkQualityTestProgress\"\x000\x01\x12P\n" +
	"\rStartSTUNTest\x12\x1c.sbox.daemon.STUNTestRequest\x1a\x1d.sbox.daemon.STUNTestProgress\"\x000\x01\x12Z\n" +
	"\x18SubscribeTailscaleStatus\x12\x16.google.protobuf.Empty\x1a\".sbox.daemon.TailscaleStatusUpdate\"\x000\x01\x12_\n" +
	"\x12StartTailscalePing\x12!.sbox.daemon.TailscalePingRequest\x1a\".sbox.daemon.TailscalePingResponse\"\x000\x01\x12Z\n" +
	"\x14SetTailscaleExitNode\x12(.sbox.daemon.SetTailscaleExitNodeRequest\x1a\x16.google.protobuf.Empty\"\x00\x12P\n" +
	"\x0fTailscaleLogout\x12#.sbox.daemon.TailscaleLogoutRequest\x1a\x16.google.protobuf.Empty\"\x00\x12p\n" +
	"\x18StartTailscaleSSHSession\x12&.sbox.daemon.TailscaleSSHClientMessage\x1a&.sbox.daemon.TailscaleSSHServerMessage\"\x00(\x010\x01\x12Y\n" +
	"\x11ProvideUSBDevices\x12\x1f.sbox.daemon.USBProviderMessage\x1a\x1d.sbox.daemon.USBServerMessage\"\x00(\x010\x01\x12^\n" +
	"\x1aSubscribeUSBIPServerStatus\x12\x16.google.protobuf.Empty\x1a$.sbox.daemon.USBIPServerStatusUpdate\"\x000\x01\x12^\n" +
	"\x1aSubscribeOpenConnectStatus\x12\x16.google.protobuf.Empty\x1a$.sbox.daemon.OpenConnectStatusUpdate\"\x000\x01\x12i\n" +
	"\x1dSubmitOpenConnectAuthResponse\x12..sbox.daemon.OpenConnectAuthResponseSubmission\x1a\x16.google.protobuf.Empty\"\x00\x12g\n" +
	"\x1eCancelOpenConnectAuthChallenge\x12+.sbox.daemon.OpenConnectAuthChallengeCancel\x1a\x16.google.protobuf.Empty\"\x00\x12V\n" +
	"\x16SubscribeOpenVPNStatus\x12\x16.google.protobuf.Empty\x1a .sbox.daemon.OpenVPNStatusUpdate\"\x000\x01\x12c\n" +
	"\x1eSubmitOpenVPNChallengeResponse\x12'.sbox.daemon.OpenVPNChallengeSubmission\x1a\x16.google.protobuf.Empty\"\x00\x12W\n" +
	"\x16CancelOpenVPNChallenge\x12#.sbox.daemon.OpenVPNChallengeCancel\x1a\x16.google.protobuf.Empty\"\x00B%Z#github.com/sagernet/sing-box/daemonb\x06proto3"
...
var file_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_started_service_proto_goTypes = []any{
	(LogLevel)(0),                             // 0: sbox.daemon.LogLevel
	(ConnectionEventType)(0),                  // 1: sbox.daemon.ConnectionEventType
	(USBDeviceState)(0),                       // 2: sbox.daemon.USBDeviceState
	(USBBackend)(0),                           // 3: sbox.daemon.USBBackend
	(ServiceStatus_Type)(0),                   // 4: sbox.daemon.ServiceStatus.Type
	(*Version)(nil),                           // 5: sbox.daemon.Version
	(*ServiceStatus)(nil),                     // 6: sbox.daemon.ServiceStatus
	(*SubscribeStatusRequest)(nil),            // 7: sbox.daemon.SubscribeStatusRequest
	(*Log)(nil),                               // 8: sbox.daemon.Log
	(*DefaultLogLevel)(nil),                   // 9: sbox.daemon.DefaultLogLevel
	(*Status)(nil),                            // 10: sbox.daemon.Status
	(*Groups)(nil),                            // 11: sbox.daemon.Groups
	(*Group)(nil),                             // 12: sbox.daemon.Group
	(*GroupItem)(nil),                         // 13: sbox.daemon.GroupItem
	(*URLTestRequest)(nil),                    // 14: sbox.daemon.URLTestRequest
	(*SelectOutboundRequest)(nil),             // 15: sbox.daemon.SelectOutboundRequest
	(*SetGroupExpandRequest)(nil),             // 16: sbox.daemon.SetGroupExpandRequest
	(*ClashMode)(nil),                         // 17: sbox.daemon.ClashMode
	(*ClashModeStatus)(nil),                   // 18: sbox.daemon.ClashModeStatus
	(*SubscribeConnectionsRequest)(nil),       // 19: sbox.daemon.SubscribeConnectionsRequest
	(*ConnectionEvent)(nil),                   // 20: sbox.daemon.ConnectionEvent
	(*ConnectionEvents)(nil),                  // 21: sbox.daemon.ConnectionEvents
	(*Connection)(nil),                        // 22: sbox.daemon.Connection
	(*ProcessInfo)(nil),                       // 23: sbox.daemon.ProcessInfo
	(*CloseConnectionRequest)(nil),            // 24: sbox.daemon.CloseConnectionRequest
	(*DeprecatedWarnings)(nil),                // 25: sbox.daemon.DeprecatedWarnings
	(*DeprecatedWarning)(nil),                 // 26: sbox.daemon.DeprecatedWarning
	(*StartedAt)(nil),                         // 27: sbox.daemon.StartedAt
	(*OutboundList)(nil),                      // 28: sbox.daemon.OutboundList
	(*NetworkQualityTestRequest)(nil),         // 29: sbox.daemon.NetworkQualityTestRequest
	(*NetworkQualityTestProgress)(nil),        // 30: sbox.daemon.NetworkQualityTestProgress
	(*STUNTestRequest)(nil),                   // 31: sbox.daemon.STUNTestRequest
	(*STUNTestProgress)(nil),                  // 32: sbox.daemon.STUNTestProgress
	(*TailscaleStatusUpdate)(nil),             // 33: sbox.daemon.TailscaleStatusUpdate
	(*TailscaleEndpointStatus)(nil),           // 34: sbox.daemon.TailscaleEndpointStatus
	(*TailscaleUserGroup)(nil),                // 35: sbox.daemon.TailscaleUserGroup
	(*TailscalePeer)(nil),                     // 36: sbox.daemon.TailscalePeer
	(*TailscalePingRequest)(nil),              // 37: sbox.daemon.TailscalePingRequest
	(*TailscalePingResponse)(nil),             // 38: sbox.daemon.TailscalePingResponse
	(*SetTailscaleExitNodeRequest)(nil),       // 39: sbox.daemon.SetTailscaleExitNodeRequest
	(*TailscaleLogoutRequest)(nil),            // 40: sbox.daemon.TailscaleLogoutRequest
	(*TailscaleSSHClientMessage)(nil),         // 41: sbox.daemon.TailscaleSSHClientMessage
	(*TailscaleSSHStart)(nil),                 // 42: sbox.daemon.TailscaleSSHStart
	(*TailscaleSSHInput)(nil),                 // 43: sbox.daemon.TailscaleSSHInput
	(*TailscaleSSHResize)(nil),                // 44: sbox.daemon.TailscaleSSHResize
	(*TailscaleSSHServerMessage)(nil),         // 45: sbox.daemon.TailscaleSSHServerMessage
	(*TailscaleSSHAuthBanner)(nil),            // 46: sbox.daemon.TailscaleSSHAuthBanner
	(*TailscaleSSHReady)(nil),                 // 47: sbox.daemon.TailscaleSSHReady
	(*TailscaleSSHOutput)(nil),                // 48: sbox.daemon.TailscaleSSHOutput
	(*TailscaleSSHExit)(nil),                  // 49: sbox.daemon.TailscaleSSHExit
	(*TailscaleSSHError)(nil),                 // 50: sbox.daemon.TailscaleSSHError
	(*USBProviderMessage)(nil),                // 51: sbox.daemon.USBProviderMessage
	(*USBServerMessage)(nil),                  // 52: sbox.daemon.USBServerMessage
	(*USBDeviceDescriptor)(nil),               // 53: sbox.daemon.USBDeviceDescriptor
	(*USBDeviceAttach)(nil),                   // 54: sbox.daemon.USBDeviceAttach
	(*USBInterface)(nil),                      // 55: sbox.daemon.USBInterface
	(*USBDeviceDetach)(nil),                   // 56: sbox.daemon.USBDeviceDetach
	(*USBDeviceReady)(nil),                    // 57: sbox.daemon.USBDeviceReady
	(*USBURBRequest)(nil),                     // 58: sbox.daemon.USBURBRequest
	(*USBURBResponse)(nil),                    // 59: sbox.daemon.USBURBResponse
	(*USBIsoPacket)(nil),                      // 60: sbox.daemon.USBIsoPacket
	(*USBEndpointAbort)(nil),                  // 61: sbox.daemon.USBEndpointAbort
	(*USBError)(nil),                          // 62: sbox.daemon.USBError
	(*USBIPServerStatusUpdate)(nil),           // 63: sbox.daemon.USBIPServerStatusUpdate
	(*USBIPServerStatus)(nil),                 // 64: sbox.daemon.USBIPServerStatus
	(*USBSharedDevice)(nil),                   // 65: sbox.daemon.USBSharedDevice
	(*OpenConnectStatusUpdate)(nil),           // 66: sbox.daemon.OpenConnectStatusUpdate
	(*OpenConnectEndpointStatus)(nil),         // 67: sbox.daemon.OpenConnectEndpointStatus
	(*OpenConnectTunnelInfo)(nil),             // 68: sbox.daemon.OpenConnectTunnelInfo
	(*OpenConnectAuthChallenge)(nil),          // 69: sbox.daemon.OpenConnectAuthChallenge
	(*OpenConnectAuthForm)(nil),               // 70: sbox.daemon.OpenConnectAuthForm
	(*OpenConnectAuthFormField)(nil),          // 71: sbox.daemon.OpenConnectAuthFormField
	(*OpenConnectAuthFormChoice)(nil),         // 72: sbox.daemon.OpenConnectAuthFormChoice
	(*OpenConnectBrowserRequest)(nil),         // 73: sbox.daemon.OpenConnectBrowserRequest
	(*OpenConnectBrowserCookie)(nil),          // 74: sbox.daemon.OpenConnectBrowserCookie
	(*OpenConnectBrowserHeader)(nil),          // 75: sbox.daemon.OpenConnectBrowserHeader
	(*OpenConnectAuthFormResponse)(nil),       // 76: sbox.daemon.OpenConnectAuthFormResponse
	(*OpenConnectBrowserResult)(nil),          // 77: sbox.daemon.OpenConnectBrowserResult
	(*OpenConnectAuthResponseSubmission)(nil), // 78: sbox.daemon.OpenConnectAuthResponseSubmission
	(*OpenConnectAuthChallengeCancel)(nil),    // 79: sbox.daemon.OpenConnectAuthChallengeCancel
	(*OpenVPNStatusUpdate)(nil),               // 80: sbox.daemon.OpenVPNStatusUpdate
	(*OpenVPNEndpointStatus)(nil),             // 81: sbox.daemon.OpenVPNEndpointStatus
	(*OpenVPNTunnelInfo)(nil),                 // 82: sbox.daemon.OpenVPNTunnelInfo
	(*OpenVPNChallenge)(nil),                  // 83: sbox.daemon.OpenVPNChallenge
	(*OpenVPNChallengeSubmission)(nil),        // 84: sbox.daemon.OpenVPNChallengeSubmission
	(*OpenVPNChallengeCancel)(nil),            // 85: sbox.daemon.OpenVPNChallengeCancel
	(*Log_Message)(nil),                       // 86: sbox.daemon.Log.Message
	nil,                                       // 87: sbox.daemon.OpenConnectAuthFormResponse.ValuesEntry
	(*emptypb.Empty)(nil),                     // 88: google.protobuf.Empty
}
var file_started_service_proto_depIdxs = []int32{
	4,  // 0: sbox.daemon.ServiceStatus.status:type_name -> sbox.daemon.ServiceStatus.Type
	86, // 1: sbox.daemon.Log.messages:type_name -> sbox.daemon.Log.Message
	0,  // 2: sbox.daemon.DefaultLogLevel.level:type_name -> sbox.daemon.LogLevel
	12, // 3: sbox.daemon.Groups.group:type_name -> sbox.daemon.Group
	13, // 4: sbox.daemon.Group.items:type_name -> sbox.daemon.GroupItem
	1,  // 5: sbox.daemon.ConnectionEvent.type:type_name -> sbox.daemon.ConnectionEventType
	22, // 6: sbox.daemon.ConnectionEvent.connection:type_name -> sbox.daemon.Connection
	20, // 7: sbox.daemon.ConnectionEvents.events:type_name -> sbox.daemon.ConnectionEvent
	23, // 8: sbox.daemon.Connection.processInfo:type_name -> sbox.daemon.ProcessInfo
	26, // 9: sbox.daemon.DeprecatedWarnings.warnings:type_name -> sbox.daemon.DeprecatedWarning
	13, // 10: sbox.daemon.OutboundList.outbounds:type_name -> sbox.daemon.GroupItem
	34, // 11: sbox.daemon.TailscaleStatusUpdate.endpoints:type_name -> sbox.daemon.TailscaleEndpointStatus
	36, // 12: sbox.daemon.TailscaleEndpointStatus.self:type_name -> sbox.daemon.TailscalePeer
	35, // 13: sbox.daemon.TailscaleEndpointStatus.userGroups:type_name -> sbox.daemon.TailscaleUserGroup
	36, // 14: sbox.daemon.TailscaleEndpointStatus.exitNode:type_name -> sbox.daemon.TailscalePeer
	36, // 15: sbox.daemon.TailscaleUserGroup.peers:type_name -> sbox.daemon.TailscalePeer
	42, // 16: sbox.daemon.TailscaleSSHClientMessage.start:type_name -> sbox.daemon.TailscaleSSHStart
	43, // 17: sbox.daemon.TailscaleSSHClientMessage.input:type_name -> sbox.daemon.TailscaleSSHInput
	44, // 18: sbox.daemon.TailscaleSSHClientMessage.resize:type_name -> sbox.daemon.TailscaleSSHResize
	46, // 19: sbox.daemon.TailscaleSSHServerMessage.authBanner:type_name -> sbox.daemon.TailscaleSSHAuthBanner
	47, // 20: sbox.daemon.TailscaleSSHServerMessage.ready:type_name -> sbox.daemon.TailscaleSSHReady
	48, // 21: sbox.daemon.TailscaleSSHServerMessage.output:type_name -> sbox.daemon.TailscaleSSHOutput
	49, // 22: sbox.daemon.TailscaleSSHServerMessage.exit:type_name -> sbox.daemon.TailscaleSSHExit
	50, // 23: sbox.daemon.TailscaleSSHServerMessage.error:type_name -> sbox.daemon.TailscaleSSHError
	54, // 24: sbox.daemon.USBProviderMessage.attach:type_name -> sbox.daemon.USBDeviceAttach
	56, // 25: sbox.daemon.USBProviderMessage.detach:type_name -> sbox.daemon.USBDeviceDetach
	59, // 26: sbox.daemon.USBProviderMessage.urbResponse:type_name -> sbox.daemon.USBURBResponse
	57, // 27: sbox.daemon.USBServerMessage.ready:type_name -> sbox.daemon.USBDeviceReady
	58, // 28: sbox.daemon.USBServerMessage.urbRequest:type_name -> sbox.daemon.USBURBRequest
	61, // 29: sbox.daemon.USBServerMessage.abort:type_name -> sbox.daemon.USBEndpointAbort
	62, // 30: sbox.daemon.USBServerMessage.error:type_name -> sbox.daemon.USBError
	55, // 31: sbox.daemon.USBDeviceDescriptor.interfaces:type_name -> sbox.daemon.USBInterface
	53, // 32: sbox.daemon.USBDeviceAttach.descriptor:type_name -> sbox.daemon.USBDeviceDescriptor
	60, // 33: sbox.daemon.USBURBRequest.isoPackets:type_name -> sbox.daemon.USBIsoPacket
	60, // 34: sbox.daemon.USBURBResponse.isoPackets:type_name -> sbox.daemon.USBIsoPacket
	64, // 35: sbox.daemon.USBIPServerStatusUpdate.servers:type_name -> sbox.daemon.USBIPServerStatus
	65, // 36: sbox.daemon.USBIPServerStatus.devices:type_name -> sbox.daemon.USBSharedDevice
	53, // 37: sbox.daemon.USBSharedDevice.descriptor:type_name -> sbox.daemon.USBDeviceDescriptor
	3,  // 38: sbox.daemon.USBSharedDevice.backend:type_name -> sbox.daemon.USBBackend
	2,  // 39: sbox.daemon.USBSharedDevice.state:type_name -> sbox.daemon.USBDeviceState
	67, // 40: sbox.daemon.OpenConnectStatusUpdate.endpoints:type_name -> sbox.daemon.OpenConnectEndpointStatus
	69, // 41: sbox.daemon.OpenConnectEndpointStatus.authChallenge:type_name -> sbox.daemon.OpenConnectAuthChallenge
	68, // 42: sbox.daemon.OpenConnectEndpointStatus.tunnelInfo:type_name -> sbox.daemon.OpenConnectTunnelInfo
	70, // 43: sbox.daemon.OpenConnectAuthChallenge.form:type_name -> sbox.daemon.OpenConnectAuthForm
	73, // 44: sbox.daemon.OpenConnectAuthChallenge.browser:type_name -> sbox.daemon.OpenConnectBrowserRequest
	71, // 45: sbox.daemon.OpenConnectAuthForm.fields:type_name -> sbox.daemon.OpenConnectAuthFormField
	72, // 46: sbox.daemon.OpenConnectAuthFormField.options:type_name -> sbox.daemon.OpenConnectAuthFormChoice
	87, // 47: sbox.daemon.OpenConnectAuthFormResponse.values:type_name -> sbox.daemon.OpenConnectAuthFormResponse.ValuesEntry
	74, // 48: sbox.daemon.OpenConnectBrowserResult.cookies:type_name -> sbox.daemon.OpenConnectBrowserCookie
	75, // 49: sbox.daemon.OpenConnectBrowserResult.headers:type_name -> sbox.daemon.OpenConnectBrowserHeader
	76, // 50: sbox.daemon.OpenConnectAuthResponseSubmission.form:type_name -> sbox.daemon.OpenConnectAuthFormResponse
	77, // 51: sbox.daemon.OpenConnectAuthResponseSubmission.browser:type_name -> sbox.daemon.OpenConnectBrowserResult
	81, // 52: sbox.daemon.OpenVPNStatusUpdate.endpoints:type_name -> sbox.daemon.OpenVPNEndpointStatus
	83, // 53: sbox.daemon.OpenVPNEndpointStatus.challenge:type_name -> sbox.daemon.OpenVPNChallenge
	82, // 54: sbox.daemon.OpenVPNEndpointStatus.tunnelInfo:type_name -> sbox.daemon.OpenVPNTunnelInfo
	0,  // 55: sbox.daemon.Log.Message.level:type_name -> sbox.daemon.LogLevel
	88, // 56: sbox.daemon.StartedService.GetVersion:input_type -> google.protobuf.Empty
	88, // 57: sbox.daemon.StartedService.SubscribeServiceStatus:input_type -> google.protobuf.Empty
	88, // 58: sbox.daemon.StartedService.SubscribeLog:input_type -> google.protobuf.Empty
	88, // 59: sbox.daemon.StartedService.GetDefaultLogLevel:input_type -> google.protobuf.Empty
	88, // 60: sbox.daemon.StartedService.ClearLogs:input_type -> google.protobuf.Empty
	7,  // 61: sbox.daemon.StartedService.SubscribeStatus:input_type -> sbox.daemon.SubscribeStatusRequest
	88, // 62: sbox.daemon.StartedService.SubscribeGroups:input_type -> google.protobuf.Empty
	88, // 63: sbox.daemon.StartedService.GetClashModeStatus:input_type -> google.protobuf.Empty
	88, // 64: sbox.daemon.StartedService.SubscribeClashMode:input_type -> google.protobuf.Empty
	17, // 65: sbox.daemon.StartedService.SetClashMode:input_type -> sbox.daemon.ClashMode
	14, // 66: sbox.daemon.StartedService.URLTest:input_type -> sbox.daemon.URLTestRequest
	15, // 67: sbox.daemon.StartedService.SelectOutbound:input_type -> sbox.daemon.SelectOutboundRequest
	16, // 68: sbox.daemon.StartedService.SetGroupExpand:input_type -> sbox.daemon.SetGroupExpandRequest
	19, // 69: sbox.daemon.StartedService.SubscribeConnections:input_type -> sbox.daemon.SubscribeConnectionsRequest
	24, // 70: sbox.daemon.StartedService.CloseConnection:input_type -> sbox.daemon.CloseConnectionRequest
	88, // 71: sbox.daemon.StartedService.CloseAllConnections:input_type -> google.protobuf.Empty
	88, // 72: sbox.daemon.StartedService.GetDeprecatedWarnings:input_type -> google.protobuf.Empty
	88, // 73: sbox.daemon.StartedService.GetStartedAt:input_type -> google.protobuf.Empty
	88, // 74: sbox.daemon.StartedService.SubscribeOutbounds:input_type -> google.protobuf.Empty
	29, // 75: sbox.daemon.StartedService.StartNetworkQualityTest:input_type -> sbox.daemon.NetworkQualityTestRequest
	31, // 76: sbox.daemon.StartedService.StartSTUNTest:input_type -> sbox.daemon.STUNTestRequest
	88, // 77: sbox.daemon.StartedService.SubscribeTailscaleStatus:input_type -> google.protobuf.Empty
	37, // 78: sbox.daemon.StartedService.StartTailscalePing:input_type -> sbox.daemon.TailscalePingRequest
	39, // 79: sbox.daemon.StartedService.SetTailscaleExitNode:input_type -> sbox.daemon.SetTailscaleExitNodeRequest
	40, // 80: sbox.daemon.StartedService.TailscaleLogout:input_type -> sbox.daemon.TailscaleLogoutRequest
	41, // 81: sbox.daemon.StartedService.StartTailscaleSSHSession:input_type -> sbox.daemon.TailscaleSSHClientMessage
	51, // 82: sbox.daemon.StartedService.ProvideUSBDevices:input_type -> sbox.daemon.USBProviderMessage
	88, // 83: sbox.daemon.StartedService.SubscribeUSBIPServerStatus:input_type -> google.protobuf.Empty
	88, // 84: sbox.daemon.StartedService.SubscribeOpenConnectStatus:input_type -> google.protobuf.Empty
	78, // 85: sbox.daemon.StartedService.SubmitOpenConnectAuthResponse:input_type -> sbox.daemon.OpenConnectAuthResponseSubmission
	79, // 86: sbox.daemon.StartedService.CancelOpenConnectAuthChallenge:input_type -> sbox.daemon.OpenConnectAuthChallengeCancel
	88, // 87: sbox.daemon.StartedService.SubscribeOpenVPNStatus:input_type -> google.protobuf.Empty
	84, // 88: sbox.daemon.StartedService.SubmitOpenVPNChallengeResponse:input_type -> sbox.daemon.OpenVPNChallengeSubmission
	85, // 89: sbox.daemon.StartedService.CancelOpenVPNChallenge:input_type -> sbox.daemon.OpenVPNChallengeCancel
	5,  // 90: sbox.daemon.StartedService.GetVersion:output_type -> sbox.daemon.Version
	6,  // 91: sbox.daemon.StartedService.SubscribeServiceStatus:output_type -> sbox.daemon.ServiceStatus
	8,  // 92: sbox.daemon.StartedService.SubscribeLog:output_type -> sbox.daemon.Log
	9,  // 93: sbox.daemon.StartedService.GetDefaultLogLevel:output_type -> sbox.daemon.DefaultLogLevel
	88, // 94: sbox.daemon.StartedService.ClearLogs:output_type -> google.protobuf.Empty
	10, // 95: sbox.daemon.StartedService.SubscribeStatus:output_type -> sbox.daemon.Status
	11, // 96: sbox.daemon.StartedService.SubscribeGroups:output_type -> sbox.daemon.Groups
	18, // 97: sbox.daemon.StartedService.GetClashModeStatus:output_type -> sbox.daemon.ClashModeStatus
	17, // 98: sbox.daemon.StartedService.SubscribeClashMode:output_type -> sbox.daemon.ClashMode
	88, // 99: sbox.daemon.StartedService.SetClashMode:output_type -> google.protobuf.Empty
	88, // 100: sbox.daemon.StartedService.URLTest:output_type -> google.protobuf.Empty
	88, // 101: sbox.daemon.StartedService.SelectOutbound:output_type -> google.protobuf.Empty
	88, // 102: sbox.daemon.StartedService.SetGroupExpand:output_type -> google.protobuf.Empty
	21, // 103: sbox.daemon.StartedService.SubscribeConnections:output_type -> sbox.daemon.ConnectionEvents
	88, // 104: sbox.daemon.StartedService.CloseConnection:output_type -> google.protobuf.Empty
	88, // 105: sbox.daemon.StartedService.CloseAllConnections:output_type -> google.protobuf.Empty
	25, // 106: sbox.daemon.StartedService.GetDeprecatedWarnings:output_type -> sbox.daemon.DeprecatedWarnings
	27, // 107: sbox.daemon.StartedService.GetStartedAt:output_type -> sbox.daemon.StartedAt
	28, // 108: sbox.daemon.StartedService.SubscribeOutbounds:output_type -> sbox.daemon.OutboundList
	30, // 109: sbox.daemon.StartedService.StartNetworkQualityTest:output_type -> sbox.daemon.NetworkQualityTestProgress
	32, // 110: sbox.daemon.StartedService.StartSTUNTest:output_type -> sbox.daemon.STUNTestProgress
	33, // 111: sbox.daemon.StartedService.SubscribeTailscaleStatus:output_type -> sbox.daemon.TailscaleStatusUpdate
	38, // 112: sbox.daemon.StartedService.StartTailscalePing:output_type -> sbox.daemon.TailscalePingResponse
	88, // 113: sbox.daemon.StartedService.SetTailscaleExitNode:output_type -> google.protobuf.Empty
	88, // 114: sbox.daemon.StartedService.TailscaleLogout:output_type -> google.protobuf.Empty
	45, // 115: sbox.daemon.StartedService.StartTailscaleSSHSession:output_type -> sbox.daemon.TailscaleSSHServerMessage
	52, // 116: sbox.daemon.StartedService.ProvideUSBDevices:output_type -> sbox.daemon.USBServerMessage
	63, // 117: sbox.daemon.StartedService.SubscribeUSBIPServerStatus:output_type -> sbox.daemon.USBIPServerStatusUpdate
	66, // 118: sbox.daemon.StartedService.SubscribeOpenConnectStatus:output_type -> sbox.daemon.OpenConnectStatusUpdate
	88, // 119: sbox.daemon.StartedService.SubmitOpenConnectAuthResponse:output_type -> google.protobuf.Empty
	88, // 120: sbox.daemon.StartedService.CancelOpenConnectAuthChallenge:output_type -> google.protobuf.Empty
	80, // 121: sbox.daemon.StartedService.SubscribeOpenVPNStatus:output_type -> sbox.daemon.OpenVPNStatusUpdate
	88, // 122: sbox.daemon.StartedService.SubmitOpenVPNChallengeResponse:output_type -> google.protobuf.Empty
	88, // 123: sbox.daemon.StartedService.CancelOpenVPNChallenge:output_type -> google.protobuf.Empty
...
func file_started_service_proto_init() {
	...
	file_started_service_proto_msgTypes[73].OneofWrappers = []any{
